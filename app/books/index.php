...
<body>
    ...
    <main>
        ...
        <div id="options">
            <a href="../ebooks/ebooks-list/">
                <div class="option">
                    <img src="../../resources/images/ebooks-option-icon.png" alt="Էլեկտրոնային գրքերի ժանրեր">
                    <p>Էլեկտրոնային գրքեր</p>
                </div>
            </a>
            <a href="../physical-books/">
                <div class="option">
                    <img src="../../resources/images/physical-books-option-icon.png" alt="Ֆիզիկական գրքերի ժանրեր">
                    <p>Ֆիզիկական գրքեր</p>
                </div>
            </a>
        </div>
